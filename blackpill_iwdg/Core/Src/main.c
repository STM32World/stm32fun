...
int main(void)
{
    ...
    // The IWDG is configured with a prescaler of 16 and a countdown of 3000 resulting in a
    // 1.5 second reset delay.  If we kick the watchdog every second we should be fine.
    // uint32_t wdg_reset_interval = 1495;
