...
//uint32_t *boot_count = (uint32_t *)(flash_storage);
...
int main(void)
{
    ...
    uint32_t *boot_count = (uint32_t*)((uint32_t *)&flash_storage)[0];
    ...
    if (flash_storage_update(boot_count, *boot_count + 1, 4) != 0) {
